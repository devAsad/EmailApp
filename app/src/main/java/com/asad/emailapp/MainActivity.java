...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message = findViewById(R.id.editTextSubject);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (s1.equals("") || s2.equals("") || s3.equals("")) {
                    ...
                    Intent emailIntent = new Intent(Intent.ACTION_SEND, Uri.fromParts("msilto:", s1, null));
                    ...
                    if (emailIntent.resolveActivity(getPackageManager())!= null){
                        ...
                        Toast.makeText(MainActivity.this, "no activity found to haandle Intent", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
